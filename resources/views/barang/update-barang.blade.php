    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('update-barang', $data->id) }}" method="post" class="needs-validation" novalidate
                        enctype="multipart/form-data">
                        @csrf
                        {{-- @method('PUT')
                        <!-- Gunakan method PUT untuk melakukan update --> --}}
                            ...
                            <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-2 m-2 ">
                                            <div class="text-center">
                                                <img id="image-preview" src="{{ asset('foto-barang/' . $data->foto) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($kategori as $index => $kat)
                                            <option value="{{ $kat->id }}"
                                                @if ($data->kategori_id == $kat->id) selected @endif>{{ $kat->kategori }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('kategori_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="Barang Tetap" @if ($data->aset == 'Barang Tetap') selected @endif>
                                            Barang Tetap</option>
                                        <option value="Barang Habis Pakai"
                                            @if ($data->aset == 'Barang Habis Pakai') selected @endif>Barang Habis Pakai</option>
                                    </select>
                                    @error('aset')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($satuan as $index => $sat)
                                            <option value="{{ $sat->id }}"
                                                @if ($data->satuan_id == $sat->id) selected @endif>{{ $sat->satuan }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('satuan_id')
                        ...
                        <div class="d-flex flex-row ">
                            <div class="col-sm-12 col-md-6">
                                <a href="{{ route('barang') }}" class="btn btn-primary btn-block">Cancel</a>
                            </div>
                            <div class="col-sm-12 col-md-6">
