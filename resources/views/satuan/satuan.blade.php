        ...
        <div class="card-body">
            <div class="row align-items-center justify-content-between mb-4 ">
                <div class="col-sm-6 col-md-5 ">
                    <form action="{{ route('satuan') }}" method="GET" class="d-flex">
                ...
                <div class="col-sm-6 col-md-auto">
                    <a href="{{ route('tambah-satuan') }}" class="text-white " style="text-decoration: none;">
                        ...
                        @else
                            @foreach ($data as $index => $satuan)
                                <tr>
                                    ...
                                    <td>
                                        <div class="button">
                                            <a href="{{ route('tampil-satuan', $satuan->id) }}"
                                            ...
                                            <a href="#" class="btn btn-icon btn-sm btn-primary dlt-satuan"
                                                data-id="{{ $satuan->id }}" data-name="{{ $satuan->satuan }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 24 24">
                                                    <path fill="currentColor"
