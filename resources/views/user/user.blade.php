        ...
        <div class="card-body">
            <div class="row align-items-center justify-content-between mb-4 ">
                ...
                <div class="col-sm-6 col-md-auto">
                    <a href="{{ route('tambah-user') }}" class="text-white " style="text-decoration: none;">
                        ...
                        @else
                            @foreach ($data as $index => $user)
                                <tr>
                                    ...
                                    <td>
                                        <div class="button">
                                            <a href="{{ route('tampil-user', $user->id) }}"
                                            ...
                                            <a href="#" class="btn btn-icon btn-sm btn-primary dlt-user"
                ...
                $('.dlt-user').click(function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location = "/delete-user/" + iduser + ""
                            Swal.fire(
                                'Deleted!',
