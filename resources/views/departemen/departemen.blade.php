...
@section('container')
        ...
        <div class="card-body">
            <div class="row align-items-center justify-content-between mb-4 ">
                <div class="col-sm-6 col-md-5 ">
                    <form action="{{ route('departemen') }}" method="GET" class="d-flex">
                ...
                <div class="col-sm-6 col-md-auto">
                    <a href="{{ route('tambah-departemen') }}" class="text-white " style="text-decoration: none;">
            ...
            <div class="table-responsive text-wrap">
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        @else
                            @foreach ($data as $index => $departemen)
                                <tr>
                                    ...
                                    <td>
                                        <div class="button">
                                            <a href="{{ route('tampil-departemen', $departemen->id) }}"
                                            ...
                                            <a href="#" class="btn btn-icon btn-sm btn-primary dlt-departemen"
                                                data-id="{{ $departemen->id }}" data-name="{{ $departemen->departemen }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 24 24">
                                                    <path fill="currentColor"
    ...
    @push('js')
        ...
        <script>
            $('.dlt-departemen').click(function() {
                var iddepartemen = $(this).attr('data-id');
                var departemen = $(this).attr('data-name');
                Swal.fire({
                    title: 'Apakah Anda Yakin??',
                    text: "Kamu akan menghapus data " + departemen + "",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        window.location = "/delete-departemen/" + iddepartemen + ""
                        Swal.fire(
                            'Deleted!',
                            'Data ' + departemen + ' Telah Dihapus',
                            'success'
                        )
                    }
                });
