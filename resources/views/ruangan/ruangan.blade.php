        ...
        <div class="card-body">
            <div class="row align-items-center justify-content-between mb-4 ">
                <div class="col-sm-6 col-md-5 ">
                    <form action="{{ route('ruangan') }}" method="GET" class="d-flex">
                ...
                <div class="col-sm-6 col-md-auto">
                    <a href="{{ route('tambah-ruangan') }}" class="text-white " style="text-decoration: none;">
                        ...
                        @else
                            @foreach ($data as $index => $ruangan)
                                <tr>
                                    ...
                                    <td>
                                        <div class="button">
                                            <a href="{{ route('tampil-ruangan', $ruangan->id) }}"
                                            ...
                                            <a href="#" class="btn btn-icon btn-sm btn-primary dlt-ruangan"
                                                data-id="{{ $ruangan->id }}" data-name="{{ $ruangan->ruangan }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                    viewBox="0 0 24 24">
                                                    <path fill="currentColor"
