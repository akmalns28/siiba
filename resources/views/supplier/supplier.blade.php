...
@section('container')
        ...
        <div class="card-body">
            <div class="row align-items-center justify-content-between mb-4 ">
                ...
                <div class="col-sm-6 col-md-auto">
                    <a href="{{ route('tambah-supplier') }}" class="text-white " style="text-decoration: none;">
                        ...
                        @else
                            @foreach ($data as $index => $supplier)
                                <tr>
                                    ...
                                    <td>
                                        <div class="button">
                                            <a href="{{ route('tampil-supplier', $supplier->id) }}"
                                            ...
                                            <a href="#" class="btn btn-icon btn-sm btn-primary dlt-supplier"
    ...
    @push('js')
        ...
        <script>
            $('.dlt-supplier').click(function() {
                var idsupplier = $(this).attr('data-id');
                var supplier = $(this).attr('data-name');
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location = "/delete-supplier/" + idsupplier + ""
                        Swal.fire(
                            'Deleted!',
